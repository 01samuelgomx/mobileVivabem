...
export default function Home({ navigation }) {
    return (
      <ScrollView contentContainerStyle={estilo.dashView}>
        ...
        <Text style={{fontFamily: 'Segoe UI', fontSize: 40, fontWeight: '700', color: '#34495e', marginTop: 50}}>Olá, Samuel</Text>
        <Text style={{fontFamily: 'Segoe UI', fontSize: 25, fontWeight: '400', color: '#707070', marginTop: 30}}> Plano Gold</Text>
        ...
        <View style={estilo.dashB2}>
          ...
          <CustomButton title="Acesse suas aulas" onPress={() => navigation.navigate('Aulas')} buttonStyle={estilo.btnDash} textStyle={estilo.TextoBtnDash} />
